defmodule Day02 do
  ...
  def solve1 do
    Input.read("day02")
      |> String.split("\n")
      |> Enum.reduce("", &append_next_number/2)
  end

  defp append_next_number(row, code) do
    last_number = (String.last(code) || "5") |> String.to_integer
    next_number = Keypad.track(row, last_number)
    code <> Integer.to_string(next_number)
  end
end
